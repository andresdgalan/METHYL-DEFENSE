...
En este documento presento algunos resultados sobre los patrones de metilación de H.murinum bajo distintos tratamientos de herbivoría. 
...
# Here I paste the path to the original files which is not inside the project due to their great size
 bam_dir <- "C:/Users/iglorena.IRNASE/Documents/andres/INTERTROPHIC/EPIGENETICA/NOVOGENE_DOWNLOAD/methylation_report_hordeum/andres_genome_pe"
 ...
 # BAD QUALITY AND POOR EFFICIENCY ALIGNMENT:
bad_samples <- c("301", "302", "305", "308", "315", "316B", "317", "319", "322", "323", "326", "334", "337", "340A", "340B", "342", "346", "351", "359")

# PATTERN TO DETECT BAD SAMPLES
pattern <- paste0("HO(", paste(bad_samples, collapse="|"), ")_")

# FILTER bam.list WITHOUT BAM SAMPLES
bam.list <- bam.list[!grepl(pattern, bam.list)]
...
# Add prefix "HO" to bad_samples
bad_samples <- paste0("HO", bad_samples)

# Remove BAD SAMPLES from TREATMENT TABLE
treatment_table <- treatment_table[!treatment_table$id %in% bad_samples, ]
...
ggplot(dapc_scores, aes(x = LD1, y = LD2, color = combined)) +
  ...
  # Legend title
  labs(title = "DAPC of CpG Methylation in H.murinum",
       x = "LD1", y = "LD2",
