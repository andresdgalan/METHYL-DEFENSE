...
1.  Se utilizó como genoma de referencia el ensamblaje UofA_Burton_1 (Plantago ovata, GCA_028274465.1), descargado de NCBI Genome el [02/09/2025] en el siguiente enlace: https://www.ncbi.nlm.nih.gov/datasets/genome/GCA_028274465.1/
...
bam_dir <- "C:/Users/iglorena.IRNASE/Documents/andres/INTERTROPHIC/EPIGENETICA/NOVOGENE_DOWNLOAD/methylation_report_plantago/ncbi_genome"
...
# THIS STEP TAKES TOO LONG SO I WILL ONLY RUN IT WHEN I NEED TO CHANGE IT
  ...
  plantago_CpG_obj@treatment <- treatment_multi
   ...
   saveRDS(plantago_CpG_obj, file = "plantago_ncbi_CpG.rds")
```

```{r CpG LOADING METHYLOBJECT AND UNITING, include=FALSE}
plantago_CpG_obj <- readRDS(here("plantago_ncbi", "plantago_ncbi_CpG.rds"))
...
write.table(loadings_df, "plantago_ncbi_CpG_loadings_with_positions.csv",
